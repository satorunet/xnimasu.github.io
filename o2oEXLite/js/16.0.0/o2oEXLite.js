	...
	function crFilterUI() {
		...
		canvas.filters.hexagonalPixelate = new Filter(
			'モザイク', 'hexagonalPixelate', function() {
				...
				this.previewFilter('canvas.fxCanvas.draw(texture).hexagonalPixelate(0.5, 0.5, '+this.size+').update();');
		});
		canvas.filters.dotScreen = new Filter(
			'ハーフトーン', 'dotScreen', function() {
				...
				this.previewFilter('canvas.fxCanvas.draw(texture).dotScreen(0.5, 0.5, '+this.angle+', '+this.size+').update();');
		});
		canvas.filters.colorHalftone = new Filter(
			'カラーハーフトーン', 'colorHalftone', function() {
				...
				this.previewFilter('canvas.fxCanvas.draw(texture).colorHalftone(0.5, 0.5, '+this.angle+', '+this.size+').update();');
		});
