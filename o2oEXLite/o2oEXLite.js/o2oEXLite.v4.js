...
var CANVAS_SIZE_MOB = ['180x180','270x50', '270x220', '300x300','270x490'];
...
function crLayerPreview(num) {
	var layerPreviewDiv = $('<div>', {class: 'layerPreviewDiv'});
	var layerNameDisp = $('<div>', {class: 'layerNameDisp'});
	var layerNameInput = $('<input>', {class: 'layerNameInput'});
...
function updateLayerPreview() {
	...
	var layerPreviewDisplay = preview.el.parent().children('.layerNameDisp');
...
function copyLayer() {
	...
	var layerName = canvas.layer.name;
	addLayer();
